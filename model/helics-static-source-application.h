#ifndef HELICS_STATIC_SOURCE_APPLICATION_H
#define HELICS_STATIC_SOURCE_APPLICATION_H
 ...
 */
class HelicsStaticSourceApplication : public HelicsApplication
{
public:
  /**
  ...
  HelicsStaticSourceApplication ();

  virtual ~HelicsStaticSourceApplication ();
...
#endif /* HELICS_STATIC_SOURCE_APPLICATION_H */
